...
def LoadTurtles():
    ...
    ##Kings
    TurtleList.Get(3, 0).shape("WKing.gif")
    TurtleList.Get(3, 7).shape("BKing.gif")
    ##Queens
    TurtleList.Get(4, 0).shape("WQueen.gif")
    TurtleList.Get(4, 7).shape("BQueen.gif")
    return TurtleList
